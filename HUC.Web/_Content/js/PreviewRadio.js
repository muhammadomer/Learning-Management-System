function PreviewRadio(jasonObj) {
    debugger;
    var questionId = 0;
    var autoTrigger = 0;
                  ...
                  <div class="ev-component ev-mcq-component ev-component-full">
                      ...
                      <div class="ev-buttons ev-buttons-full">
                          ...
                          <div class="ev-buttons-cluster-bottom ev-clearfix">
                              <button type="button" class="ev-button ev-primary ev-buttons-action ${this.jasonObj.divId}" data-question-id = "${this.jasonObj.divId.split('-')[1]}" aria-hidden="true" aria-label="Select this button to submit your answer" disabled="">
    ...
    this.initialize = () => {
        ...
        //$("input[type='radio']." + this.jasonObj.divId).on("click", (e) => {
